      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
        ...
        <div className="lg:col-span-4 flex flex-col gap-gutter">
          ...
          <section className="bg-surface-container-lowest border border-outline-variant/30 rounded-xl shadow-sm flex flex-col h-[400px]">
                ...
                return (
                  <div key={msg.id} className={`flex gap-sm ${isSelf ? 'flex-row-reverse' : ''}`}>
                    ...
                    <div className="max-w-[75%]">
                      ...
                      <div className={`border rounded-2xl p-sm text-label-sm inline-block shadow-sm ${
                        isSelf
            ...
            {/* Input area */}
            <form onSubmit={handleSendMessage} className="p-sm border-t border-outline-variant/20 bg-white rounded-b-xl flex gap-xs">
              <input
                disabled={!activeRoom}
                type="text"
                value={chatInput}
              ...
              <button
                disabled={!activeRoom}
                type="submit"
                className="w-8 h-8 rounded-full bg-primary hover:bg-primary/95 disabled:bg-slate-300 text-on-primary flex items-center justify-center cursor-pointer transition-colors"
              >
