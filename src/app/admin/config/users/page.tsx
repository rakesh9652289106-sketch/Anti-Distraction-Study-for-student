            ...
            <div>
              ...
              <form onSubmit={handleSaveUserChanges} className="space-y-md">
                ...
                <div className="pt-xs flex gap-sm">
                  <button
                    type="submit"
                    className="flex-1 py-2 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-bold rounded-lg text-xs hover:from-emerald-500 hover:to-emerald-650 cursor-pointer shadow-md"
                  >
                    Save Changes
                  </button>
                  <button
